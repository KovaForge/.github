...
_Source of truth for model data: `/Users/mike/.openclaw/openclaw.json`, read live on 2026-05-26._
...
_Source of truth: OpenClaw `/Users/mike/.openclaw/openclaw.json` and Hermes `/Users/mike/.hermes/config.yaml` plus `/Users/mike/.hermes/profiles/*/config.yaml`, read live on 2026-05-26._
...
| `grok-4.3` | `xai` | OpenClaw | ⚙️ **Viktor Hale** | `MiniMax-M2.7` | Primary reasoning model |
| `grok-4.20-beta-latest-reasoning` | `xai` | OpenClaw | ⚙️ **Viktor Hale** | `MiniMax-M2.7` | Extended context (2M), reasoning variant |
| `grok-4.20-beta-latest-non-reasoning` | `xai` | OpenClaw | ⚙️ **Viktor Hale** | `MiniMax-M2.7` | Extended context (2M), non-reasoning variant |
